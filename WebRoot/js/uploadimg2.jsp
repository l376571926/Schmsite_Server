...
<LINK 
href="/schmsite/admin/images/syscome.files/Admin.css" rel=stylesheet>
<SCRIPT language=javascript src="/schmsite/admin/images/syscome.files/Admin.js"></SCRIPT>
<script type="text/javascript" src="/schmsite/js/popup.js"></script>
...
if(filename!=null)
{
 ...
 txt.src="/schmsite/upfile/<%=filename%>";
 popclose();
 </script>
 <%} %>
<form action="/schmsite/schmsite?ac=uploadimg2" enctype="multipart/form-data" name="f1" method="post">
...
if(suc!=null)
{
 %>
 alert("操作成功");
  parent.location.replace("/schmsite/admin/kcfiles.jsp");
 <%}%>
 </script>
