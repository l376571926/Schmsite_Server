        ...
        <td valign="top"><table width="735" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            <td height="30" valign="bottom" background="/schmsite/frontfiles/images/ri.jpg"><table width="670" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td align="left" class="right">用户注册</td>
              </tr>
            </table></td>
          </tr>
          <tr>
...
<tr>
          ...
          <td width="75%" align="left" valign="middle" class="dd"><span class="left_txt2"><input type="password"  onblur='checkform()' class='' id='upass' name='upass' size=35 /><label id='clabelupass' />&nbsp; </span></td>
          </tr>
          
          <tr>
          <td width="25%" height="32" align="center" valign="middle" class="dd"><span class="left_txt2">再次输入密码：</span></td>
          <td width="75%" align="left" valign="middle" class="dd"><span class="left_txt2"><input type="password"   onblur='checkform()' class='' id='reupass' name='reupass' size=35 /><label id='clabelreupass' />&nbsp; </span></td>
          </tr>
  ...
  <tr align="center" valign="middle">
    <td height="39" colspan="3" id="page">
         ...
         <input type="submit" value="提交" name="B1" />         
		  ...
		  <input class="p_input" type="reset" name="s" value="重置"   />
		 	</td>
  </tr>
</table>
</form>
...
if(reupassobj.value!=upassobj.value){  
