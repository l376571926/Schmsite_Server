        ...
        <td valign="top"><table width="735" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            <td height="30" valign="bottom" background="/schmsite/frontfiles/images/ri.jpg"><table width="670" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td align="left" class="right">今日特价</td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td  valign="top" background="/schmsite/frontfiles/images/ri2.jpg"><table width="670" border="0" align="center" cellpadding="0" cellspacing="0" style="margin:10px;">
              <tr>
  ...
  <tr align="center" valign="middle">
    <td height="39" colspan="3" id="page">&nbsp;
		  ...
		  <tr>
            <td height="30" valign="bottom" background="/schmsite/frontfiles/images/ri.jpg"><table width="670" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td align="left" class="right">精品推荐</td>
              </tr>
            </table></td>
          </tr>
          <tr>
    ...
    <td width="300%" colspan="3">
      <table width="100%"  border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
                    ...
                    sql = "select * from pros where status='上架'   and discount!=''  ";
  ...
  <tr align="center" valign="middle">
    <td height="39" colspan="3" id="page">&nbsp;
		  ...
		  <tr>
            <td height="30" valign="bottom" background="/schmsite/frontfiles/images/ri.jpg"><table width="670" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td align="left" class="right">热卖图书</td>
              </tr>
            </table></td>
          </tr>
          <tr>
