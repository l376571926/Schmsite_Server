  ...
  <tr>
    ...
    <font color=gray>
      ...
      <tr>
        ...
        <td width="290" height="39" align="left" valign="middle"><font color=gray><span style="display: inline">
          <input type="text" name="uname" id="uname" size="11" onmouseover="this.focus();" style="width: 130px"  />
        </span></font></td>
      </tr>
      <tr>
        <td height="39" align="center" valign="middle"><font color=gray><span style="display: inline"> 密码 :<br /></span></font></td>
      ...
      <tr>
        <td height="39" align="center" valign="middle"><font color="gray"><span style="display: inline">验证码 :<br /></span></font></td>
        <td height="39" align="left" valign="middle" >
        
        <input class=wenbenkuang name=pagerandom type=text value="" maxLength=4 size=3 />
                               
           <img src="/schmsite/admin/ma.jsp" id="yzm" ></img> &nbsp; <span onClick="ma();" style="cursor: hand"  class="login_txt">换一张</span>
      ...
      <tr>
        <td height="39" colspan="2" align="center" valign="middle"><font color=gray><span style="display: inline">
