...
public class Info {
    ...
    public static void writeExcel(String fileName, String prosstr, java.util.List<List> plist, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            response.sendRedirect("/schmsite/upload?filename=" + fileName.substring(fileName.lastIndexOf("/") + 1));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static String getFileUpInfo() {
        String jscode = "";
        jscode += "<script src=/schmsite/js/popup.js></script>";
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (!str1.equals("content")) {
                    ...
                    jscode += "{\n";
                    jscode += "document.getElementById(\"txt\").src=\"/schmsite/upfile/" + map.get("filename") + "\";\n";
                    jscode += "}\n";

                    jscode += "if(document.getElementById(\"txt2\"))\n";
                    jscode += "{\n";
                    jscode += "document.getElementById(\"txt2\").src=\"/schmsite/upfile/" + map.get("filename2") + "\";\n";
                    jscode += "}\n";

                    jscode += "if(document.getElementById(\"txt3\"))\n";
                    jscode += "{\n";
                    jscode += "document.getElementById(\"txt3\").src=\"/schmsite/upfile/" + map.get("filename3") + "\";\n";
                    jscode += "}\n";

                    jscode += "if(document.getElementById(\"txt4\"))\n";
                    jscode += "{\n";
                    jscode += "document.getElementById(\"txt4\").src=\"/schmsite/upfile/" + map.get("filename4") + "\";\n";
                    jscode += "}\n";

                    jscode += "if(document.getElementById(\"txt5\"))\n";
                    jscode += "{\n";
                    jscode += "document.getElementById(\"txt5\").src=\"/schmsite/upfile/" + map.get("filename5") + "\";\n";
                    jscode += "}\n";
    ...
    public static String getImgUpInfo(int height) {
        String jscode = "";
        jscode += "<img style=\"cursor: hand;margin:3px\" onclick=\"uploadimg()\" src=\"/schmsite/js/nopic.jpg\" id=txt height=\"" + height + "\"/>";
        jscode += "<input type=hidden name=\"filename\" id=\"filename\" value=\"\" />";
        jscode += "<script type=\"text/javascript\"  src=\"/schmsite/js/popups.js\"></script>";
        return jscode;
    }
    ...
    public static String getImgUpInfo2(int height) {
        String jscode = "";
        jscode += "<img style=\"cursor: hand\" onclick=\"uploadimg2()\" src=\"/schmsite/js/nopic.jpg\" id=txt2 height=\"" + height + "\"/>";
        jscode += "<input type=hidden name=\"filename2\" id=\"filename2\" value=\"\" />";
        jscode += "<script type=\"text/javascript\"  src=\"/schmsite/js/popup.js\"></script>";
        return jscode;
    }

    public static String getImgUpInfo3(int height) {
        String jscode = "";
        jscode += "<img style=\"cursor: hand\" onclick=\"uploadimg3()\" src=\"/schmsite/js/nopic.jpg\" id=txt3 height=\"" + height + "\"/>";
    ...
    public static String getImgUpInfo4(int height) {
        String jscode = "";
        jscode += "<img style=\"cursor: hand\" onclick=\"uploadimg4()\" src=\"/schmsite/js/nopic.jpg\" id=txt4 height=\"" + height + "\"/>";
    ...
    public static String getImgUpInfo5(int height) {
        String jscode = "";
        jscode += "<img style=\"cursor: hand\" onclick=\"uploadimg5()\" src=\"/schmsite/js/nopic.jpg\" id=txt5 height=\"" + height + "\"/>";
    ...
    public static String fck(int height, String content) {
        ...
        jscode += "<script type=\"text/javascript\"  src=\"/schmsite/fckeditor/fckeditor.js\"></script>";
        jscode += "<script language=\"javascript\">";
        jscode += "function fckinit()";
        jscode += "{";
        jscode += " var of = new FCKeditor(\"content\");";
        jscode += "of.BasePath=\"/schmsite/fckeditor/\";";
